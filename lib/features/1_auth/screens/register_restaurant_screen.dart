...
class RegisterPageRestaurant extends StatefulWidget {
  const RegisterPageRestaurant({super.key});

  @override
  State<RegisterPageRestaurant> createState() => _RegisterPageRestaurantState();
}

class _RegisterPageRestaurantState extends State<RegisterPageRestaurant> {
    ...
    try {
      ...
      if (success) {
        Fluttertoast.showToast(
          msg: "Account created! Now let's setup your restaurant!",
          toastLength: Toast.LENGTH_LONG,
          backgroundColor: Colors.green,
          textColor: Colors.white,
        );

        // Navigate to restaurant setup screen
